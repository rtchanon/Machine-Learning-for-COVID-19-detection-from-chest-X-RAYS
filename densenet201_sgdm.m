...
digitDatasetPath = fullfile('C:\Users\Administrator\Downloads\archive\COVID-19_Radiography_Dataset');
...
for foldi = 1:k
    ...
    save(sprintf('Densenet201_sgdm_%d',foldi),'netTransfer','test_idx','train_idx', 'info');
    
    % Confusion Matrix
    figure;
    plotconfusion(actual_labels,predicted_labels)
    title(sprintf('Confusion Matrix: Densenet201 sgdm_%d',foldi));
end
